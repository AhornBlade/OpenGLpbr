...
void Camera::MouseMotionEvent(float x, float y)
{
	...
	glm::mat4 RotationMatrix = glm::rotate(RotationMatrix, -Rotation.y, glm::vec3{ 1, 0, 0 }) * glm::rotate(RotationMatrix, -Rotation.x, glm::vec3{ 0, 1, 0 });
...
void Camera::Update(float DeltaTime)
{
	...
	glm::vec3 LeftRightTranslation = m_KeySpeed * DeltaTime * SlideDirection * 5.0f;
	glm::vec3 UpDownTranslation = m_KeySpeed * DeltaTime * glm::normalize(m_Up) * 10.0f;
